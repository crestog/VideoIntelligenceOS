"""
VIOS Omniscient — GraphRAG Prompt Suite

Verbatim prompt library used by the Omniscient engine for:
  • entity/relationship extraction into Neo4j (GraphRAG)
  • query rewriting for entity/visual retrieval
  • keyword extraction
  • VideoRAG response synthesis (with/without references, multiple choice)
"""
